        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Descriptions.Item label="Tên sản phẩm">{dataViewDetail?.mainText}</Descriptions.Item>
                    <Descriptions.Item label="Nhà sản xuất">{dataViewDetail?.author}</Descriptions.Item>
                    ...
                    <Descriptions.Item label="Ngành hàng" span={2}>
